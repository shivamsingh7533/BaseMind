...
CONVERSATIONS = [
    {
        ...
        "status": "resolved",
        "time": "10:42 AM",
        "preview": "I need help configuring the embedding model for my custom dataset.",
        "messageCount": 8,
        "duration": "4m 12s",
        "startedAt": "10:42 AM",
        "messages": [
            ...
            },
            {
                ...
                "role": "agent",
                "text": (
                    "Switching to local embeddings can improve privacy and reduce costs. "
                    "To configure this in BaseMind, you'll need to update your agent's configuration YAML.\n\n"
            ...
            },
            {
                ...
                "role": "agent",
                "text": (
                    'Go to **Knowledge > Settings > Advanced** and paste it in the "Vector DB Config" editor.\n\n'
                    "For 10,000 documents with `all-MiniLM-L6-v2` running locally, re-indexing "
                    "typically takes between **5 to 15 minutes** depending on your host machine's CPU."
                ),
                "time": "10:43:05 AM",
                "latencyNote": "3s latency",
            },
    ...
    },
    {
        ...
        "messages": [
            ...
            },
            {
                ...
                "role": "agent",
                "text": (
                    "Empty responses usually mean the retrieval step found no relevant chunks. "
                    "Could you share which document collection your agent is pointed at?"
                ),
                "time": "09:15:14 AM",
    ...
    },
    {
        ...
        "messages": [
            ...
            },
            {
                ...
                "role": "agent",
                "text": (
                    "API_RATE_LIMIT_EXCEEDED — monthly message quota reached. "
